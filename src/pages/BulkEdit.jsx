...
function BulkEdit({ showNotification }) {
	...
	const handleApplyBulkStatus = () => {
		...
		if (showNotification) {
			...
			showNotification(
				`Статус ${selectedIds.length} технологий изменен на: ${statusLabels[bulkStatus]}`,
				'success'
			)
		}
	...
	const handleDeleteSelected = () => {
		...
		// Показываем уведомление
		if (showNotification) {
			showNotification(`Удалено технологий: ${count}`, 'success')
		}
